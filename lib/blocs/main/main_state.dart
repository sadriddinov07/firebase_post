...
class SearchDataSuccess extends MainState {
  const SearchDataSuccess(super.items);

  @override
  List<Object> get props => [items];
}

class GetAllDataSuccess extends MainState {
  const GetAllDataSuccess(super.items);

  @override
  List<Object> get props => [items];
}

class GetPrivateDataSuccess extends MainState {
  const GetPrivateDataSuccess(super.items);
